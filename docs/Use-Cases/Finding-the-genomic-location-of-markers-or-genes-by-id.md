# Finding the genomic location of markers or genes by ID
...
Enter the a list of feature names into the search text box input and press the search button. The feature names can be marker IDs or gene IDs.
