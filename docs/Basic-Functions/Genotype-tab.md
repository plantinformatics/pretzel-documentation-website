...
Accessions can be added via a pop out menu from the genotype tab. If working with genotype data generated by the AGG Strategic Partnership, you will need to search by accession number/genotype ID. To find the AGG accession number/genotype ID for an accession of interest, use <a href="https://genolink.plantinformatics.io/">Genolink</a> to <a href="https://docs.plantinformatics.io/Genolink/user-guide/#wild-text-search">search by accession name</a>.
